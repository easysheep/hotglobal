...
//     { title: "Health", imageUrl: "/health.jpg" },
...
//         <div className="cardcontainer grid grid-cols-2 lg:grid-cols-5 xl:grid-cols-5 gap-4 pt-6 pb-12">
...
//         <div className="two-box flex md:flex-col lg:flex-row xl:flex-row gap-2 h-96" id="section2">
  ...
  return (
    <div>
      <div className="pt-10 pb-10">
        ...
        <div className="two-box flex flex-col lg:flex-row gap-2 h-96" id="section2">
        <div className="right w-full lg:w-1/4 p-2">
            <div className="text-4xl font-monte font-bold pb-4">
              Popular Pages
            </div>
            <div className="gap-3 flex flex-col">
          ...
          <div className="left w-full lg:w-3/4 p-2">
            <div className="text-4xl font-bold font-monte">Recent Posts</div>
            <div className="grid grid-row-8 gap-8 pt-4 pb-6">
              {recentposts.map((data, index) => {
                return <RecentPost key={index} {...data} />;
